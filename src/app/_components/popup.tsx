  ...
  <div> 
    <dialog className='bg-slate-400 rounded-lg' ref={dialogRef}>
      ...
      <form className='text-center text-3xl' method="post" onSubmit={handleSubmit}>
        <input type="text" className='p-2 m-1 border-2 border-dotted border-black rounded-md mx-2 bg-slate-300' name="username" placeholder="Username" autoFocus required/><br/>
        <input type="password" className='p-2 m-1 border-2 border-dotted border-black rounded-md mx-2 bg-slate-300' name="password" placeholder='Password' required/><br/>
