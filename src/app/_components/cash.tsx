            ...
            <div className="border-slate-500 border-2 rounded-lg">
                ...
                <div className="grid grid-rows-2 h-fit">
                    <div className="grid grid-cols-2">
                        ...
                        <div className="m-5">
                            <div  className="grid grid-rows-7">
                                ...
                                <h1 id="items_list" className="w-full overflow-y-scroll my-2 rounded-md bg-slate-500 text-2xl px-2">{}</h1>
                    ...
                    <div className="m-5 border-2 border-slate-500 rounded-lg text-xl h-fill bg-slate-400 text-center">
                        ...
                        <button onClick={handleCashOut} className="text-center text-3xl font-semibold border-2 border-dotted border-black rounded-2xl px-10 py-2 bg-green-400 hover:bg-green-200">Submit</button>
                    </div>
