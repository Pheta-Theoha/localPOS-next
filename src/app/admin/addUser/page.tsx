...
export default function AddUser(){
    ...
    return (
        <div className="grid place-content-evenly h-screen text-center px-32 bg-gradient-to-r from-slate-400 to-red-900">
            <div className="drop-shadow-[0_6px_6px_rgba(10,10,10,10)] border-2 border-dotted bg-gradient-to-r from-slate-300 via-slate-400 to-slate-600 py-10 px-5 rounded-xl">
                ...
                <form method="post" onSubmit={handleSubmit} className="">
                    <div className="grid grid-cols-2">
                        ...
                        <div className="grid m-2">
                            ...
                            <input type="password" name="password" placeholder="Password" className="mx-10 text-3xl text-white font-semibold bg-gradient-to-l from-slate-300 via-slate-400 to-slate-700 border-2 border-transparent rounded-xl py-3 px-2 w-full md:w-auto" required/><br/>
                            <input type="password" name="confirmPassword" placeholder="Confirm Password" className="mx-10 text-3xl text-white font-semibold bg-gradient-to-l from-slate-300 via-slate-700 to-slate-700 border-2 border-transparent rounded-xl py-3 px-2 w-full md:w-auto" required/><br/>
                        </div>
                    </div>
                    <div className="text-center">
                        ...
                        <Link href="/admin" className="text-2xl text-blue-600 font-bold underline hover:text-2xl hover:text-white">Cancel Operation</Link>
                    </div>
                </form>
            </div>
        </div>
